class preloadScene extends Phaser.Scene {
  ...
  create () {
    ...
    this.add.text(80,100, 'Desert Survival',
    { font: '50px Courier', fill: '#ffffff' });

this.add.text(80,180, 'Your mission is to collect',
    { font: '20px Courier', fill: '#ffffff' });

    this.add.text(80,210, '3xwater, 3xpumpkin, 3xweapon',
    { font: '20px Courier', fill: '#ffffff' });

this.add.text(80,450, 'Press spacebar to continue', 
